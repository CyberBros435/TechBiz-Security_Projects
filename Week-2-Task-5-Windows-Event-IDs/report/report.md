...
![Windows Fundamentals 1](w1.png)

![Investigating Windows Environment](w2.png)

![Event Viewer — Security Log Filtered for Event ID 4624](w3.png)

![Event ID 4624 Details](w4.png)
